...
//     var id   = $(this).parent()[0].id.split("_")[1];
//     var text = this.value
//     $.ajax({type:"PUT", url:'/notes/'+id, data: JSON.stringify({'note':{'text':text}})});
//     
//   });
//   
...
//   //   var id   = $(this).parent()[0].id.split("_")[1];
//   //   var text = this.value
//   //   $.ajax({type:"PUT", url:'/notes/'+id+'/softupdate', data: JSON.stringify({'note':{'id':id,'text':text}})});
//   // });
//   
